document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fetch(actionUrl, {
      ...
      .catch(function (err) {
        showFormMessage(form, err.message || 'Something went wrong. Please try again.', 'error');
      })
      .finally(function () {
        if (submitBtn) {
  ...
  function clearFormErrors(form) {
    ...
    form.querySelectorAll('.form-error-message, .form-success-message, .form-global-message').forEach(function (el) {
      el.remove();
    });
  }
  ...
  function showFormSuccess(form) {
    const successMsg = form.getAttribute('data-success') || 'Thank you! Your message has been sent.';
    showFormMessage(form, successMsg, 'success');
  }

  function showFormMessage(form, message, type) {
    const existing = form.querySelector('.form-global-message');
    if (existing) existing.remove();

    const msgEl = document.createElement('div');
    msgEl.className = 'form-global-message form-' + type + '-message';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'b04c9bbd-8bf2-4d1c-b4fe-d4c8a58e94c6',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'b04c9bbd-8bf2-4d1c-b4fe-d4c8a58e94c6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b04c9bbd-8bf2-4d1c-b4fe-d4c8a58e94c6';
